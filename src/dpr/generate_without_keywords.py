...
def main(cfg: DictConfig):
    ...
    #########################################################################################
    for mode in ["naive", "hyde", "rewrite"]:
        in_file_path = f"/home/stv10121/RUS/bm25_result/keyword_none_{mode}.json"
        with open(in_file_path, 'r', encoding='utf-8') as in_file:
            datas = json.load(in_file)["data"]

        result_dict = {"data": []}
        print(f"##### keyword_none_{mode}_generation #####")
        for id, data in enumerate(tqdm(datas)):
            ...
            # generate output
            output = generate(query_org, papers)
        ...
        out_file_path = f"/home/stv10121/RUS/dpr_result/keyword_none_{mode}.json"
