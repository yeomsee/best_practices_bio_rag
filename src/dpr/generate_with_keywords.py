...
def main(cfg: DictConfig):
    ...
    for mode in ["hyde", "rewrite"]:
        in_file_path = f"/home/stv10121/RUS/bm25_result/keyword_{mode}.json"
        with open(in_file_path, 'r', encoding='utf-8') as in_file:
            datas = json.load(in_file)["data"]

        result_dict = {"data": []}
        print(f"##### keyword_{mode}_generation #####")
        ...
        out_file_path = f"/home/stv10121/RUS/dpr_result/keyword_{mode}.json"
